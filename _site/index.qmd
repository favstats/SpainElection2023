...
<div id="overlay" onclick="off()">
  <div id="text">
    ...
    <h2>Welcome to the 2023 Dutch Election Dashboard</h2>
    <p>This dashboard aggregates data from the <a href="https://www.facebook.com/ads/library/" target="_blank">Meta Ad Library</a> to show how citizens are targeted during the 2023 Dutch parliamentary election.</p>
